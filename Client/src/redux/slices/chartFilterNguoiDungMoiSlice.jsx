...
const chartFilterNguoiDungMoiSlice = createSlice({
    name: 'chartFilterNguoiDungMoi',
    initialState,
    reducers: {
...
export const { labelShow, setDayTime } = chartFilterNguoiDungMoiSlice.actions;
export default chartFilterNguoiDungMoiSlice.reducer;
